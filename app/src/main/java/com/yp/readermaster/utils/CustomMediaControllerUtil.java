 ...
 * on 2016/12/16 0016 10:10
 * 自定义视频播放器
 */

public class CustomMediaControllerUtil extends MediaController {
    ...
    public CustomMediaControllerUtil(Context context, VideoView videoView, Activity activity) {
        super(context);
